...
Aus dem Workaround ist ein Ritual geworden. Es gibt Kurse, Vorlagenmärkte und Kanzleihandbücher für Formulierungen, deren Zweck darin besteht, eine technische Schwäche auszugleichen, die bei den aktuellen Modellen weitgehend behoben ist. Bemerkenswert ist, wer inzwischen davon abrät: die Hersteller selbst. OpenAI hält in seinen [Hinweisen zu Reasoning-Modellen](https://platform.openai.com/docs/guides/reasoning-best-practices) fest, die Aufforderung „denke Schritt für Schritt" sei überflüssig, weil diese Modelle intern ohnehin so arbeiten; knappe, direkte Anweisungen seien besser. Anthropic empfiehlt für Claude, [erst allgemein zu formulieren](https://docs.claude.com/en/docs/build-with-claude/prompt-engineering/extended-thinking-tips) und den Denkweg nicht kleinteilig vorzuschreiben — eine übergeordnete Aufforderung, gründlich nachzudenken, trägt dort oft weiter als eine vorgegebene Schrittfolge.
...
Die Studie misst Texteingabe, nicht Beratungsqualität, und sie ist an kurzen Sätzen auf einem Smartphone entstanden; übertragen Sie den Faktor nicht ungeprüft auf jedes Diktat am Schreibtisch.

Bei mir sieht es konkret so aus: Das Diktierwerkzeug, mit dem ich arbeite, weist mir 102 Wörter pro Minute aus und ordnet mich damit den obersten zwei Prozent seiner Nutzer zu. Das gesprochene Beispiel weiter oben hat 52 Wörter, in diesem Tempo also gut dreißig Sekunden. Wer dieselben 52 Wörter in dreißig Sekunden tippen wollte, müsste über hundert Wörter pro Minute schaffen — das erreicht kaum jemand, und schon gar nicht nebenbei zwischen zwei Terminen.

Genau da liegt der Punkt: Das Tempo bestimmt, wie viel Sie überhaupt sagen. Wer in derselben Minute das Dreifache unterbringt, lässt die Vorgeschichte nicht weg, nur weil sie zu mühsam zu tippen wäre. Deshalb ist der Tempovorteil kein Nebeneffekt — er ist der Grund, warum die gesprochene Eingabe mehr Kontext enthält.
